...
const LeftSidebar = () => {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className="hidden md:flex h-screen overflow-y-auto fixed flex-col gap-4 p-4 w-64 bg-white shadow-[0_0_10px_rgba(0,0,0,0.2)]">
        <div className="flex flex-col">
          <h1 className="my-3 pl-3 text-xl font-bold select-none">
            Taar
          </h1>
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-white border-t flex justify-around items-center py-2 z-50">
        ...
        {/* Create Button Center Highlight */}
        <button
          onClick={() => sidebarHandler("Create")}
          className="bg-black text-white p-3 rounded-full -mt-6 shadow-lg"
        >
          <PlusSquare />
        </button>
